...
@Database(entities = [(Customer::class), (Provider::class), (Bill::class), (Story::class), (Audio::class), (Moment::class),
    (Theme::class), (Resident::class), (Recipient::class)], version = 10, exportSchema = false)
